      ...
      <section className="labelage-products-section" id="labelage-products">
        ...
        <div className="labelage-products-grid">
          <div className="labelage-product-card">
            <img src="/img/Screenshot-from-2022-10-17-14-48-23-e1666011179370-1024x681.png" alt="Дневной крем L'abelage" className="labelage-product-img" />
          ...
          <div className="labelage-product-card">
            <img src="/img/krem-na-noc-e1666011220431-1024x773.jpg" alt="Восстанавливающий ночной крем L'abelage" className="labelage-product-img" />
            <div className="labelage-product-desc">
          ...
          <div className="labelage-product-card">
            <img src="/img/krem-pod-oko-e1666011327511-1024x743.jpg" alt="Крем для глаз и шеи L'abelage" className="labelage-product-img" />
            <div className="labelage-product-desc">
          ...
          <div className="labelage-product-card">
            <img src="/img/serum-e.jpg" alt="Сыворотка против морщин L'abelage" className="labelage-product-img" />
            <div className="labelage-product-desc">
          ...
          <div className="labelage-product-card">
            <img src="/img/ultraintensywna-maseczka-do-twarzy-e1666011519786-1024x780.jpg" alt="Интенсивная маска для лица L'abelage" className="labelage-product-img" />
            <div className="labelage-product-desc">
          ...
          <div className="labelage-product-card">
            <img src="/img/tonik.jpg" alt="Интенсивно очищающий тоник L'abelage" className="labelage-product-img" />
            <div className="labelage-product-desc">
          ...
          {/* Ещё 3 товара */}
          <div className="labelage-product-card">
            <img src="/img/gele-dly-kogi.jpg" alt="Глубоко очищающий гель для кожи лица L'abelage" className="labelage-product-img" />
            <div className="labelage-product-desc">
          ...
          <div className="labelage-product-card">
            <img src="/img/maseczka-1024x842.png" alt="Интенсивная отшелушивающая маска L'abelage" className="labelage-product-img" />
            <div className="labelage-product-desc">
          ...
          <div className="labelage-product-card">
            <img src="/img/maslo-1024x861.png" alt="Восстанавливающий увлажняющий лосьон для тела L'abelage" className="labelage-product-img" />
            <div className="labelage-product-desc">
